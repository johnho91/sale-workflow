...
class TestSaleInvoicePlan(common.TestSaleCommon):
    ...
    #     # Create an SO for Service
        cls.so_service = sale_obj.with_user(cls.company_data['default_user_salesman']).create(
            {
        ...
        cls.so_product = sale_obj.with_user(cls.company_data['default_user_salesman']).create(
            {
                "partner_id": cls.partner_customer_usd.id,
                "partner_invoice_id": cls.partner_customer_usd.id,
                "partner_shipping_id": cls.partner_customer_usd.id,
